...
class Toy extends Product
{
  ...
  public function __construct(string $_name, string $_type, string $_category, float $_fullprice, string $_img, string $_material, array $_colors, string $_interactive = null)
  {
